...
const Navbar = ({isDarkMode, setIsDarkMode}) => {
  ...
  return (
    <>
        ...
        <nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50 ${isScroll ? "bg-white bg-opacity-50 backdrop-blur-lg shadow-sm dark:bg-datkTheme dark:shadow-white/20" : ""}`}>
            <a href="#top">
                <Image src={isDarkMode? assets.logoHarsh:assets.logoHarsh} alt="" className='lg:w-28 w-16 cursor-pointer mr-14'/>
            </a>
            <ul className={`hidden md:flex items-center gap-6 lg:gap-8 rounded-full px-12 py-3 ${isScroll ? "":"bg-white shadow-sm bg-opacity-50  dark:border dark:border-white/50 dark:bg-transparent"}`}>
                ...
                <li>
                    <a href="#internship" className='font-Ovo'>Experience</a>
                </li>
                <li>
            ...
            {/* mobile menu */}
            <ul ref={sideMenuRef} className='flex md:hidden flex-col gap-4 py-20 px-10 fixed -right-64 top-0 bottom-0 w-64 z-50 h-screen bg-rose-50 transition duration-500 dark:bg-darkHover dark:text-black'>
                ...
                <li><a href="#services" className='font-Ovo' onClick={closeMenu}>Skills/Experience</a></li>
